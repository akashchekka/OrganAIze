...
class Spawner:
    """Creates child agents with budget enforcement. No DB — uses asyncio.Lock for concurrency safety."""
    ...
    async def spawn(
        ...
        """Create a new agent if budget allows. Uses asyncio.Lock for concurrency safety."""
